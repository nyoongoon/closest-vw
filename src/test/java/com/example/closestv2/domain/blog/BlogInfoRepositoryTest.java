...
class BlogInfoRepositoryTest extends RepositoryTestSupport {
...
//                .containsExactly( URI.create("https://example.com/blog123").toURL(), "제목", "작가", LocalDateTime.of(2022, 1, 1, 12, 3, 31));
//    }
//
//    @Test
